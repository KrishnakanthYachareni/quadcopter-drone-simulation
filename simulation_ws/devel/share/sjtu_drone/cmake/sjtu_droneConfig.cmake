...
if("TRUE" STREQUAL "TRUE")
  set(sjtu_drone_SOURCE_PREFIX /home/user/simulation_ws/src/sjtu_drone)
  set(sjtu_drone_DEVEL_PREFIX /home/user/simulation_ws/devel)
  ...
  set(sjtu_drone_INSTALL_PREFIX /home/user/simulation_ws/install)
...
if(NOT "/home/user/simulation_ws/src/sjtu_drone/include " STREQUAL " ")
  set(sjtu_drone_INCLUDE_DIRS "")
  set(_include_dirs "/home/user/simulation_ws/src/sjtu_drone/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sjtu_drone' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/simulation_ws/src/sjtu_drone/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;image_transport;std_msgs;sensor_msgs;geometry_msgs;message_runtime")
